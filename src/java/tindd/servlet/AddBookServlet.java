...
import tindd.tblProducts.TblProductsAddError;
...
public class AddBookServlet extends HttpServlet {
    ...
    private final Logger LOGGER = Logger.getLogger(AddBookServlet.class);

    private final String VIEW_BOOK_CONTROLLER = "DispatchController?btnAction=Add";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TblProductsAddError error = new TblProductsAddError();
                ...
                if (usersDTO != null) {
                    ...
                    if (roleName.equalsIgnoreCase("admin")) {
                        ...
                        if (image.getSize() > 0) {
                            ...
                            productsDTO = new TblProductsDTO(productName, categoryId, fileName, description, price, author, quantity);
                            boolean isAdded = productsDAO.addBook(productsDTO);

                            if (!isAdded) {
                                isError = true;
                                error.setFailToAdd("Something wrong happened!");
                            }
                        } else {
                            isError = true;
                            error.setEmptyImage("Image can not be empty!");
                        }
                    }
                }
            }
